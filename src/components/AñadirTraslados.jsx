        ...
        <main className="container py-4">
            ...
            <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-12">
                    ...
                    <span
                        title={!form.origen || !form.destino ? 'Selecciona ambos depósitos para habilitar esta opción' : ''}
                    ...
                    >
                        <button
                            ...
                            onClick={abrirModal}
                            disabled={!form.origen || !form.destino}
                            style={!form.origen || !form.destino ? { pointerEvents: 'auto' } : {}}
                        >
